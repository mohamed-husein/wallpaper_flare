...
class SportImagesScreen extends StatelessWidget {
  const SportImagesScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: BlocProvider(
        create: (context) => sl<WallpaperCubit>()..getSportWallpaper(),
        child: Scaffold(
          body: SizedBox(
            ...
            child: Column(
              children: [
                ...
                Align(
                  ...
                  child: CustomText.titleMedium(AppConstants.sports,
                      context: context),
                ),
                Align(
                  alignment: Alignment.topLeft,
                ...
                Expanded(
                  child: BlocBuilder<WallpaperCubit, WallpaperState>(
                    builder: (context, state) {
                      ...
                      if (state is GetSportsWallpaperSuccessState) {
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      fit: BoxFit.fill,
                                      image: NetworkImage(
                                          cubit.sportsWallpaper[index].image))),
                            ),
                          ),
                          itemCount: cubit.sportsWallpaper.length,
                        );
                      } else {
                        return Center(
